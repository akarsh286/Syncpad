...
import { FaPlay, FaSyncAlt, FaSave, FaCopy, FaPlus, FaSignInAlt, FaSun, FaMoon } from 'react-icons/fa';
import './App.css';
...
const EditorPage = ({ roomId, theme, setTheme }) => {
  ...
  useEffect(() => {
    ...
    s.on("room_update", (connectedClients) => { setClients(connectedClients); });
    return () => { s.disconnect(); };
  }, [roomId]);
...
// --- Main App Component with Theme Logic ---
function App() {
